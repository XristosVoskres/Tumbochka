...
public class DialogeWindow : TypewriterEffect
{
    public GameObject DialogWindow;
    public TextMeshProUGUI DialogText; // Drag сюда компонент Text из Canvas

    private List<IEnumerator> dialogLines = new List<IEnumerator>
    {
        ShowTextByLetters("Привет! Это первая реплика."),
        ShowTextByLetters("А вот и вторая строка диалога."),
        ShowTextByLetters("Конец диалога.")
    };
    ...
    //TypewriterEffect.ShowTextByLetters();
}
// class DataQuiz 
// {
